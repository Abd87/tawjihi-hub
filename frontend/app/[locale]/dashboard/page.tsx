        ...
        {(user?.role === 'ADMIN' || user?.role === 'TEACHER') ? (
          <div className="space-y-8 animate-fade-in pb-20">
             ...
             <div className="mt-12">
                 ...
                 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <Link href="/admin/library" className="flex flex-col gap-4 p-6 rounded-3xl border border-emerald-500/20 bg-emerald-500/5 hover:bg-emerald-500/10 hover:border-emerald-500/40 transition-all group">
                      <div className="p-4 bg-emerald-500/10 rounded-2xl text-emerald-400 w-16 h-16 flex items-center justify-center group-hover:scale-110 transition-transform">
          ...
          <div className="space-y-10 animate-fade-in pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8 animate-fade-in">
              ...
              <div className="flex items-center gap-4 p-5 bg-slate-900/50 border border-slate-800 rounded-2xl relative overflow-hidden">
                <div className="w-14 h-14 rounded-full bg-emerald-500/10 text-emerald-500 flex items-center justify-center shrink-0 hidden sm:flex">
