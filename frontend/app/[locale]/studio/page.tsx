          ...
          <div className="space-y-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-white group-hover:text-indigo-400 transition-colors">
                {isRtl ? 'Ø§Ù„Ø³Ø¨ÙˆØ±Ø© Ø§Ù„Ù„Ø§Ù†Ù‡Ø§Ø¦ÙŠØ©' : 'Infinite Whiteboard'}
              </h3>
              <p className="text-xs text-slate-400 mt-1.5 line-clamp-2">
                {isRtl ? 'Ù…Ø³Ø§Ø­Ø© Ø´Ø±Ø­ ÙˆØªØ¯Ø±ÙŠØ³ Ø­Ø±Ø© Ù…Ø¹ Ø¥Ù…ÙƒØ§Ù†ÙŠØ© Ø±ÙØ¹ Ù…Ù„ÙØ§Øª PDF' : 'Free teaching space with PDF upload capability'}
              </p>
            </div>
          </div>
          <div className="pt-6 flex items-center justify-between text-xs font-bold text-slate-400 group-hover:text-white">
            <span>{isRtl ? 'Ø§ÙØªØ­ Ø§Ù„Ø³Ø¨ÙˆØ±Ø©' : 'Open Whiteboard'}</span>
            {isRtl ? <ArrowLeft className="w-4 h-4" /> : <ArrowRight className="w-4 h-4" />}
          </div>
        </Link>
